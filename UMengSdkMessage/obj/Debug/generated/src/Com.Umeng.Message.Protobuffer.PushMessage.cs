...
namespace Com.Umeng.Message.Protobuffer {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.umeng.message.protobuffer']/class[@name='PushMessage']"
	[global::Android.Runtime.Register ("com/umeng/message/protobuffer/PushMessage", DoNotGenerateAcw=true)]
	public sealed partial class PushMessage : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/umeng/message/protobuffer/PushMessage", ref java_class_handle);
			}
		}
		...
		internal PushMessage (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_getDescriptor;
		public static global::Com.Google.Protobuf.Descriptors.FileDescriptor Descriptor {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message.protobuffer']/class[@name='PushMessage']/method[@name='getDescriptor' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message.protobuffer']/class[@name='PushMessage']/method[@name='registerAllExtensions' and count(parameter)=1 and parameter[1][@type='com.google.protobuf.ExtensionRegistry']]"
