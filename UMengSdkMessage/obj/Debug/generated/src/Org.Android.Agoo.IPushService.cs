...
namespace Org.Android.Agoo {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.android.agoo']/interface[@name='IPushService']"
	[Register ("org/android/agoo/IPushService", "", "Org.Android.Agoo.IPushServiceInvoker")]
	public partial interface IPushService : global::Org.Android.Agoo.IService {

	}

	[global::Android.Runtime.Register ("org/android/agoo/IPushService", DoNotGenerateAcw=true)]
	internal class IPushServiceInvoker : global::Java.Lang.Object, IPushService {

		static IntPtr java_class_ref = JNIEnv.FindClass ("org/android/agoo/IPushService");
		IntPtr class_ref;

		public static IPushService GetObject (IntPtr handle, JniHandleOwnership transfer)
		{
			return global::Java.Lang.Object.GetObject<IPushService> (handle, transfer);
		}
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.android.agoo.IPushService"));
			return handle;
		}
		...
		public IPushServiceInvoker (IntPtr handle, JniHandleOwnership transfer) : base (Validate (handle), transfer)
		{
		...
		protected override System.Type ThresholdType {
			get { return typeof (IPushServiceInvoker); }
		}
