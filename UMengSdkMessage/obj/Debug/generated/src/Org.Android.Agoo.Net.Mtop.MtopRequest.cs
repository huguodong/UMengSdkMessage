...
namespace Org.Android.Agoo.Net.Mtop {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']"
	[global::Android.Runtime.Register ("org/android/agoo/net/mtop/MtopRequest", DoNotGenerateAcw=true)]
	public sealed partial class MtopRequest : global::Java.Lang.Object {


		// Metadata.xml XPath field reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/field[@name='a']"
		[Register ("a")]
		public const string A = (string) "&";
		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("org/android/agoo/net/mtop/MtopRequest", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (MtopRequest); }
		}

		internal MtopRequest (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/constructor[@name='MtopRequest' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public MtopRequest () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (MtopRequest)) {
				SetHandle (
		...
		public string Api {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getApi' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setApi' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		public string AppKey {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getAppKey' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setAppKey' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		public string AppSecret {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getAppSecret' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setAppSecret' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		public string DeviceId {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getDeviceId' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setDeviceId' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		public string Ecode {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getEcode' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setEcode' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		public bool HasSigin {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='isHasSigin' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setHasSigin' and count(parameter)=1 and parameter[1][@type='boolean']]"
		...
		public global::System.Collections.Generic.IDictionary<string, global::Java.Lang.Object> Params {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getParams' and count(parameter)=0]"
		...
		public string SId {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getSId' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setSId' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		public global::System.Collections.Generic.IDictionary<string, string> SysParams {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getSysParams' and count(parameter)=0]"
		...
		public long Time {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getTime' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setTime' and count(parameter)=1 and parameter[1][@type='long']]"
		...
		public string TtId {
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getTtId' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setTtId' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='getV' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='putParams' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.Object']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='putParams' and count(parameter)=1 and parameter[1][@type='java.util.Map']]"
		[Register ("putParams", "(Ljava/util/Map;)V", "")]
		public void PutParams (global::System.Collections.Generic.IDictionary<string, global::Java.Lang.Object> p0)
		{
			if (id_putParams_Ljava_util_Map_ == IntPtr.Zero)
				id_putParams_Ljava_util_Map_ = JNIEnv.GetMethodID (class_ref, "putParams", "(Ljava/util/Map;)V");
			IntPtr native_p0 = global::Android.Runtime.JavaDictionary<string, global::Java.Lang.Object>.ToLocalJniHandle (p0);
			JNIEnv.CallVoidMethod  (Handle, id_putParams_Ljava_util_Map_, new JValue (native_p0));
			JNIEnv.DeleteLocalRef (native_p0);
		}

		static IntPtr id_putSysParams_Ljava_lang_String_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='putSysParams' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		...
		static IntPtr id_putSysParams_Ljava_util_Map_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='putSysParams' and count(parameter)=1 and parameter[1][@type='java.util.Map']]"
		[Register ("putSysParams", "(Ljava/util/Map;)V", "")]
		public void PutSysParams (global::System.Collections.Generic.IDictionary<string, string> p0)
		{
			if (id_putSysParams_Ljava_util_Map_ == IntPtr.Zero)
				id_putSysParams_Ljava_util_Map_ = JNIEnv.GetMethodID (class_ref, "putSysParams", "(Ljava/util/Map;)V");
			IntPtr native_p0 = global::Android.Runtime.JavaDictionary<string, string>.ToLocalJniHandle (p0);
			JNIEnv.CallVoidMethod  (Handle, id_putSysParams_Ljava_util_Map_, new JValue (native_p0));
			JNIEnv.DeleteLocalRef (native_p0);
		}

		static IntPtr id_setV_Ljava_lang_String_;
		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo.net.mtop']/class[@name='MtopRequest']/method[@name='setV' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
