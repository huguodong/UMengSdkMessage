...
namespace Com.Umeng.Message {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.umeng.message']/class[@name='MessageReceiver']"
	[global::Android.Runtime.Register ("com/umeng/message/MessageReceiver", DoNotGenerateAcw=true)]
	public partial class MessageReceiver : global::Org.Android.Agoo.Client.BaseBroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/umeng/message/MessageReceiver", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.umeng.message']/class[@name='MessageReceiver']/constructor[@name='MessageReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public MessageReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (MessageReceiver)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Umeng.Message.MessageReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Umeng.Message.MessageReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message']/class[@name='MessageReceiver']/method[@name='getIntentServiceClassName' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
