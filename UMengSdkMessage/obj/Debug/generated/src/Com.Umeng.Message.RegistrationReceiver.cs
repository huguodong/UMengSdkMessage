...
namespace Com.Umeng.Message {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.umeng.message']/class[@name='RegistrationReceiver']"
	[global::Android.Runtime.Register ("com/umeng/message/RegistrationReceiver", DoNotGenerateAcw=true)]
	public partial class RegistrationReceiver : global::Org.Android.Agoo.Client.BaseBroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/umeng/message/RegistrationReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (RegistrationReceiver); }
		}

		protected RegistrationReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.umeng.message']/class[@name='RegistrationReceiver']/constructor[@name='RegistrationReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public RegistrationReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (RegistrationReceiver)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Umeng.Message.RegistrationReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Umeng.Message.RegistrationReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message']/class[@name='RegistrationReceiver']/method[@name='getIntentServiceClassName' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
