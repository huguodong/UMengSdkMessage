...
namespace Com.Umeng.Message {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.umeng.message']/class[@name='ElectionReceiver']"
	[global::Android.Runtime.Register ("com/umeng/message/ElectionReceiver", DoNotGenerateAcw=true)]
	public partial class ElectionReceiver : global::Org.Android.Agoo.Client.BaseBroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/umeng/message/ElectionReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ElectionReceiver); }
		}

		protected ElectionReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.umeng.message']/class[@name='ElectionReceiver']/constructor[@name='ElectionReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public ElectionReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (ElectionReceiver)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Umeng.Message.ElectionReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Umeng.Message.ElectionReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message']/class[@name='ElectionReceiver']/method[@name='getIntentServiceClassName' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
