...
namespace Com.Umeng.Message.Proguard {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.umeng.message.proguard']/class[@name='aI']"
	[global::Android.Runtime.Register ("com/umeng/message/proguard/aI", DoNotGenerateAcw=true)]
	public partial class AI : global::Com.Umeng.Message.Proguard.AH {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/umeng/message/proguard/aI", ref java_class_handle);
			}
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.umeng.message.proguard']/class[@name='aI']/constructor[@name='aI' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public AI (string p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			global::Com.Umeng.Message.Proguard.AI __this = global::Java.Lang.Object.GetObject<global::Com.Umeng.Message.Proguard.AI> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.A ();
		}
#pragma warning restore 0169

		static IntPtr id_a;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message.proguard']/class[@name='aI']/method[@name='a' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message.proguard']/class[@name='aI']/method[@name='a' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='java.util.concurrent.TimeUnit']]"
...
#pragma warning restore 0169
		...
		static IntPtr id_b;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message.proguard']/class[@name='aI']/method[@name='b' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		static IntPtr id_c;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message.proguard']/class[@name='aI']/method[@name='c' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		static IntPtr id_d;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message.proguard']/class[@name='aI']/method[@name='d' and count(parameter)=0]"
