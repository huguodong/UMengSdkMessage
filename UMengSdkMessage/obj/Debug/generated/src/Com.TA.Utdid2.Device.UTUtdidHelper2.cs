...
namespace Com.TA.Utdid2.Device {
	...
	public partial class UTUtdidHelper2 : global::Java.Lang.Object {
		...
		[Register (".ctor", "()V", "")]
		public UTUtdidHelper2 () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning restore 0169
		...
		public virtual string DePackWithBase64 (string p0)
		{
			...
			string __ret;
			if (GetType () == ThresholdType)
				__ret = JNIEnv.GetString (JNIEnv.CallObjectMethod  (Handle, id_dePackWithBase64_Ljava_lang_String_, new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
			else
				__ret = JNIEnv.GetString (JNIEnv.CallNonvirtualObjectMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "dePackWithBase64", "(Ljava/lang/String;)Ljava/lang/String;"), new JValue (native_p0)), JniHandleOwnership.TransferLocalRef);
			JNIEnv.DeleteLocalRef (native_p0);
			return __ret;
		}
