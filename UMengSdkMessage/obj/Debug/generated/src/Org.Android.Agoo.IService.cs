...
namespace Org.Android.Agoo {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='org.android.agoo']/interface[@name='IService']"
	[Register ("org/android/agoo/IService", "", "Org.Android.Agoo.IServiceInvoker")]
	public partial interface IService : IJavaObject {

		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo']/interface[@name='IService']/method[@name='bind' and count(parameter)=1 and parameter[1][@type='android.content.Intent']]"
		[Register ("bind", "(Landroid/content/Intent;)Landroid/os/IBinder;", "GetBind_Landroid_content_Intent_Handler:Org.Android.Agoo.IServiceInvoker, UMengSdkMessage")]
		global::Android.OS.IBinder Bind (global::Android.Content.Intent p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo']/interface[@name='IService']/method[@name='create' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='org.android.agoo.callback.IServiceCallBack']]"
		[Register ("create", "(Landroid/content/Context;Lorg/android/agoo/callback/IServiceCallBack;)V", "GetCreate_Landroid_content_Context_Lorg_android_agoo_callback_IServiceCallBack_Handler:Org.Android.Agoo.IServiceInvoker, UMengSdkMessage")]
		void Create (global::Android.Content.Context p0, global::Org.Android.Agoo.Callback.IServiceCallBack p1);

		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo']/interface[@name='IService']/method[@name='destroy' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register ("destroy", "(Landroid/content/Context;)V", "GetDestroy_Landroid_content_Context_Handler:Org.Android.Agoo.IServiceInvoker, UMengSdkMessage")]
		void Destroy (global::Android.Content.Context p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo']/interface[@name='IService']/method[@name='startCommand' and count(parameter)=3 and parameter[1][@type='android.content.Intent'] and parameter[2][@type='int'] and parameter[3][@type='int']]"
		[Register ("startCommand", "(Landroid/content/Intent;II)I", "GetStartCommand_Landroid_content_Intent_IIHandler:Org.Android.Agoo.IServiceInvoker, UMengSdkMessage")]
		int StartCommand (global::Android.Content.Intent p0, int p1, int p2);

		// Metadata.xml XPath method reference: path="/api/package[@name='org.android.agoo']/interface[@name='IService']/method[@name='unbind' and count(parameter)=1 and parameter[1][@type='android.content.Intent']]"
		[Register ("unbind", "(Landroid/content/Intent;)Z", "GetUnbind_Landroid_content_Intent_Handler:Org.Android.Agoo.IServiceInvoker, UMengSdkMessage")]
		bool Unbind (global::Android.Content.Intent p0);

	}

	[global::Android.Runtime.Register ("org/android/agoo/IService", DoNotGenerateAcw=true)]
	internal class IServiceInvoker : global::Java.Lang.Object, IService {

		static IntPtr java_class_ref = JNIEnv.FindClass ("org/android/agoo/IService");
		IntPtr class_ref;
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "org.android.agoo.IService"));
			return handle;
		}
		...
		protected override System.Type ThresholdType {
			get { return typeof (IServiceInvoker); }
		}
...
#pragma warning disable 0169
		...
		{
			global::Org.Android.Agoo.IService __this = global::Java.Lang.Object.GetObject<global::Org.Android.Agoo.IService> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
