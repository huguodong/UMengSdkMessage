...
namespace Com.Umeng.Message {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.umeng.message']/class[@name='BootBroadcastReceiver']"
	[global::Android.Runtime.Register ("com/umeng/message/BootBroadcastReceiver", DoNotGenerateAcw=true)]
	public partial class BootBroadcastReceiver : global::Android.Content.BroadcastReceiver {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/umeng/message/BootBroadcastReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (BootBroadcastReceiver); }
		}

		protected BootBroadcastReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.umeng.message']/class[@name='BootBroadcastReceiver']/constructor[@name='BootBroadcastReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public BootBroadcastReceiver () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;

			if (GetType () != typeof (BootBroadcastReceiver)) {
				SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Umeng.Message.BootBroadcastReceiver __this = global::Java.Lang.Object.GetObject<global::Com.Umeng.Message.BootBroadcastReceiver> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.umeng.message']/class[@name='BootBroadcastReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
